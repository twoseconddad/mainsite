...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! bootstrap */ 77)(__webpack_require__(/*! App/Admin */ 18));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			DomainStore = __webpack_require__(/*! Stores/Admin/Domain */ 68),
			PluginStore = __webpack_require__(/*! Stores/Admin/Plugin */ 71),
			LicenseStore = __webpack_require__(/*! Stores/Admin/License */ 69),
			PackageStore = __webpack_require__(/*! Stores/Admin/Package */ 70),
		...
		AdminApp.prototype.bootstart = function ()
		{
			...
			else
			{
				...
				{
					kn.startScreens([
						__webpack_require__(/*! Screen/Admin/Settings */ 119)
					]);
				}
				else
				{
					kn.startScreens([
						__webpack_require__(/*! Screen/Admin/Login */ 118)
					]);
				}
			}
	...
	(function () {
		...
		function LoginAdminScreen()
		{
			AbstractScreen.call(this, 'login', [
				__webpack_require__(/*! View/Admin/Login */ 146)
			]);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractSettings = __webpack_require__(/*! Screen/AbstractSettings */ 67)
		;
		...
		function SettingsAdminScreen()
		{
			AbstractSettings.call(this, [
				__webpack_require__(/*! View/Admin/Settings/Menu */ 147),
				__webpack_require__(/*! View/Admin/Settings/Pane */ 148)
			]);
		}
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/General */ 127),
				'AdminSettingsGeneral', 'TABS_LABELS/LABEL_GENERAL_NAME', 'general', true);

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Login */ 128),
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Prem/Branding */ 131),
					'AdminSettingsBranding', 'TABS_LABELS/LABEL_BRANDING_NAME', 'branding');
			}

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Contacts */ 125),
				'AdminSettingsContacts', 'TABS_LABELS/LABEL_CONTACTS_NAME', 'contacts');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Domains */ 126),
			...
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Plugins */ 130),
				'AdminSettingsPlugins', 'TABS_LABELS/LABEL_PLUGINS_NAME', 'plugins');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Packages */ 129),
				'AdminSettingsPackages', 'TABS_LABELS/LABEL_PACKAGES_NAME', 'packages');

			if (true)
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Prem/Licensing */ 132),
					'AdminSettingsLicensing', 'TABS_LABELS/LABEL_LICENSING_NAME', 'licensing');
			}

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/About */ 123),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		PluginsAdminSettings.prototype.onPluginLoadRequest = function (sResult, oData)
		{
			if (Enums.StorageResultType.Success === sResult && oData && oData.Result)
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Plugin */ 155), [oData.Result]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			BrandingAdminSettings = __webpack_require__(/*! Settings/Admin/Branding */ 124)
		;
	...
	(function () {
		...
		function PaneSettingsAdminView()
		{
			...
			this.adminManLoading = ko.computed(function () {
				return '000' !== [
					__webpack_require__(/*! Stores/Admin/Domain */ 68).domains.loading() ? '1' : '0',
					__webpack_require__(/*! Stores/Admin/Plugin */ 71).plugins.loading() ? '1' : '0',
					__webpack_require__(/*! Stores/Admin/Package */ 70).packages.loading() ? '1' : '0'
				].join('');
			}, this);
